...
class fNIRSNet(torch.nn.Module):
    ...
    """
    def __init__(self, num_class, DHRConv_width=371, DWConv_height=26, num_DHRConv=4, num_DWConv=8):
        ...
        self.act = torch.nn.Sigmoid() if num_class==1 else torch.nn.Softmax(1)
